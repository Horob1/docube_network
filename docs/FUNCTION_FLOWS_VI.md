...
| 9 | Tạo AccessNFT | 85-94 | Đặt tất cả các trường |
| 10 | Lưu vào ledger | 97-99 | PutState |
| 11 | Admin audit | 102-106 | Nếu admin |
| 12 | Phát event | 109-114 | AccessGranted |
...
accessNFT := AccessNFT{
    ...
    OwnerID:      granteeUserID,      // Ai nhận quyền
    OwnerMSP:     granteeUserMSP,
    SystemUserId: systemUserId,
    Status:       "ACTIVE",
    GrantedBy:    caller.ID,          // Ai cấp (doc owner hoặc admin)
    GrantedAt:    timestamp,
}
```
